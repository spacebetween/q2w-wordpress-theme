...
<div class="hide-for-medium">
	<div class="mobileMenu">
		...
		<div class="mobileMenu_title">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="mobileMenu_logo" src="/wp-content/themes/q2w-wordpress-theme/assets/images/logo.jpg" alt="<?php bloginfo( 'name' ); ?>"></a>
		</div>
